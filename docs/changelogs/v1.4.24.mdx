---
title: "v1.4.24"
description: "v1.4.24 changelog - 2026-04-23"
---
<Tabs>
  <Tab title="NPX">
    ```bash
    npx -y @maximhq/bifrost --transport-version v1.4.24
    ```
  </Tab>
  <Tab title="Docker">
    ```bash
    docker pull maximhq/bifrost:v1.4.24
    docker run -p 8080:8080 maximhq/bifrost:v1.4.24
    ```
  </Tab>
</Tabs>

<Update label="Bifrost(HTTP)" description="1.4.24">
## ✨ Features
...
<Update label="Core" description="1.4.23">
...
<Update label="Framework" description="1.2.40">
...
<Update label="governance" description="1.4.40">
...
<Update label="jsonparser" description="1.4.39">
- chore: upgraded core to v1.4.23 and framework to v1.2.40

</Update>
<Update label="litellmcompat" description="0.0.29">
- chore: upgraded core to v1.4.23 and framework to v1.2.40

</Update>
<Update label="logging" description="1.4.40">
- chore: upgraded core to v1.4.23 and framework to v1.2.40
- fix: capture responses streaming API errors

</Update>
<Update label="maxim" description="1.5.40">
- chore: upgraded core to v1.4.23 and framework to v1.2.40

</Update>
<Update label="mocker" description="1.4.39">
- chore: upgraded core to v1.4.23 and framework to v1.2.40

</Update>
<Update label="otel" description="1.1.39">
- chore: upgraded core to v1.4.23 and framework to v1.2.40
- fix: sets default for `insecure` to `true` for config.json
- fix: includes fallbacks in otel metrics

</Update>
<Update label="semanticcache" description="1.4.38">
- chore: upgraded core to v1.4.23 and framework to v1.2.40

</Update>
<Update label="telemetry" description="1.4.40">
- chore: upgraded core to v1.4.23 and framework to v1.2.40
