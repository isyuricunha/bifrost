			...
			<div className="space-y-4">
					...
					<div className="flex items-center justify-between space-x-2 rounded-lg border p-4">
						<div className="space-y-0.5">
							...
							<p className="text-muted-foreground text-sm">
								...
								<code className="text-xs">x-bf-disable-content-logging</code> header or context key.
							</p>
						</div>
						<Switch
				...
				<div className="flex items-center justify-between space-x-2 rounded-lg border p-4">
						<div className="space-y-0.5">
							...
							<p className="text-muted-foreground text-sm">
								When enabled, individual requests can override raw request/response visibility using the{" "}
								<code className="text-xs">x-bf-send-back-raw-request</code> and{" "}
								<code className="text-xs">x-bf-send-back-raw-response</code> headers. When disabled, only provider-level settings control raw capture.
							</p>
						</div>
						<Switch
